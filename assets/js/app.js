...
$(document).on('click', '.card-actions a', function(e){
	...
	if ($(this).hasClass('btn-close')) {
        ...
        if ($(this).parent().parent().parent().attr('id') === 'monitoring-pane') {
			$('#system-summary-pane').parent().removeClass('col-lg-4').addClass('col-lg-3');
            $('#controller-pane').parent().removeClass('col-lg-4').addClass('col-lg-3');
            $('#spine-pane').parent().removeClass('col-lg-4').addClass('col-lg-3');
            $('#leaf-pane').parent().removeClass('col-lg-4').addClass('col-lg-3');
            $('#servers-pane').parent().removeClass('col-lg-4').addClass('col-lg-3');
            $('#services-pane').parent().removeClass('col-lg-4').addClass('col-lg-3');

            $('#fabric-and-service-pane').parent().removeClass('col-md-9').addClass('col-md-12');

            $('#leaf-pane-hide').parent().show();
            $('#leaf-pane').parent().hide();
		}
